...
<body>
	...
	<div class="container">
		...
		<center>
		        <b>
		           <font size ="6">
		                     <h1 style="background-color:DodgerBlue;">CUSTOMER RELATIONSHIP MANAGEMENT</h1>
		              </font>   
		          </b>    
		</center>
		<hr>
				...
				<c:forEach items="${Customers}" var="temp">
					<tr>
						...
						<td>
							...
							<a href="/customerManagement/customers/showFormForUpdate?id=${temp.id}"
							class="btn btn-info btn-sm"> Update </a> 
							
							<!-- Add "delete" button/link -->
							<a href="/customerManagement/customers/delete?id=${temp.id}"
